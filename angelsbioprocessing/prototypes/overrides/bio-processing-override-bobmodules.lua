...
if mods["bobmodules"] then
  ...
  for _, type in pairs({ "speed", "efficiency", "productivity", "bob-pollution-clean", "bob-pollution-create", "bob-green" }) do
    OV.add_prereq(type .. "-module-3", "modules-2")
    OV.set_research_difficulty(type .. "-module-3", 60, 100)
  end
  for _, type in pairs({ "bob-speed", "bob-efficiency", "bob-productivity", "bob-pollution-clean", "bob-pollution-create", "bob-green" }) do
    OV.add_prereq(type .. "-module-4", "modules-2")
